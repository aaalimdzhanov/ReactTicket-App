...
import mainLogoImage from '../../assets/imgs/main-logo.png'
        ...
        return (
            ...
            <div className="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
                <a className="navbar-brand brand-logo" href="index.html">
                    <img src={mainLogoImage} alt="logo"></img>
                    
                </a>
                <a className="navbar-brand brand-logo-mini" href="index.html">
                    <img src="imgs/logo-mini.svg" alt="logo"></img>
                </a>
            </div>
                ...
                <ul className="navbar-nav navbar-nav-left header-links d-none d-md-flex">
                    ...
                    <li className="nav-item active">
                        <a href="#" className="nav-link">
                                <i className="mdi mdi-chart-line"></i>Статистика
                        </a>
                    </li>
                    <li className="nav-item">
                        <a href="#" className="nav-link">
                ...
                <ul className="navbar-nav navbar-nav-right">
                        ...
                        <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                            ...
                            <a className="dropdown-item preview-item">
                                <div className="preview-thumbnail">
                                    <img src="imgs/faces/face4.jpg" alt="image" className="profile-pic"></img>
                                </div>
                            ...
                            <a className="dropdown-item preview-item">
                                <div className="preview-thumbnail">
                                    <img src="imgs/faces/face2.jpg" alt="image" className="profile-pic"></img>
                                </div>
                                <div className="preview-item-content flex-grow">
                            ...
                            <a className="dropdown-item preview-item">
                                <div className="preview-thumbnail">
                                    <img src="imgs/faces/face3.jpg" alt="image" className="profile-pic"></img>
                                </div>
                                <div className="preview-item-content flex-grow">
                    ...
                    <li className="nav-item dropdown d-none d-xl-inline-block">
                        <a className="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown"
                            ...
                            <img className="img-xs rounded-circle" src={userProfileImage}alt="Profile image"></img>
